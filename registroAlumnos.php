...
<form action="insertarBD" method="post">
		<p>Campos requeridos (*)</p>
			<center class="h">
				...
				<p><input type="text"  name="nacimiento" placeholder="Fecha de Nacimiento">aaaa/mm/dd</p>
				<p><input type="tel"   name="telefono" placeholder="Telefono"></p>
				
				<p><input type="email"  name="email" placeholder="E-Mail"></p>
				<p><textarea name="direccion" placeholder="Dirección"></textarea>
				
				<p><input type="text"  class="semestreAlumno" name="semestre" placeholder="Semestre"></p>
				<p><input type="text" class="grupocarr" name="grupocarr" placeholder="Grupo"></p>
