...
<p><input type="text" name="nivel" placeholder="Nivel" required></p>
...
<p><input type="text" name="salon" placeholder="Salon" required></p>
<p><input type="text" name="periodo" placeholder="Periodo" required></p>
...
<p><input type="submit" name="btnCrearGrupos" value="Registrar Grupo"></p>
</form>
</div>
<footer>
<center>
