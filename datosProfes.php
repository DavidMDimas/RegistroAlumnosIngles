...
$fila=$resultado->fetch_assoc();
 ...
 ?>
 <p>Nombre(s): <label><?php echo $fila['nombres']; ?></label> <input type="text" name="nombre" placeholder="<?php echo $fila['nombres']; ?>"></p>
 <p>Apellido Paterno: <label><?php echo $fila['apellido_paterno']; ?></label> <input type="text" name="apaterno" placeholder="<?php echo $fila['apellido_paterno']; ?>"></p>
<p>Apellido Materno: <label><?php echo $fila['apellido_materno']; ?></label> <input type="text"   name="amaterno" placeholder="<?php echo $fila['apellido_materno']; ?>"></p>
<p>Telefono: <label><?php echo $fila['telefono']; ?></label> <input type="text"   name="telefono" placeholder="<?php echo $fila['telefono']; ?>"> </p>
<p>E-Mail: <label><?php echo $fila['correo']; ?></label><input type="text" name="email" placeholder="<?php echo $fila['correo']; ?>"></p>
