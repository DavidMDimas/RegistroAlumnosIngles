...
while ($filaGrupo=$resp->fetch_assoc()) {
	...
	while ($filaMatriculas=$respuestaMatriculasInscritas->fetch_assoc()) {
		...
		$promedio="SELECT avg(calificacion), Alumnos_matriculaEv, nivelActual FROM evaluacion  where Alumnos_matriculaEv='$matricula' and idGrupoEv=$grupo and enCurso=1";
